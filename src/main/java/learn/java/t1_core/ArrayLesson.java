...
//        double[] doubles = new double[20];    //Создание пустого массива, состоящего из 20 элементов
...
//        int[] array = new int[n];
//        for (int i = 0; i < array.length; i++) {
//            System.out.println("Введите значение " + i + "-го элемента массива:");
...
//        for (int i = 0; i < array.length; i++) {            //Перебор строк
//            int[] element = array[i];
//            for (int j = 0; j < element.length; j++) {     //Перебор столбцов
//                System.out.print(element[j] + "\t");                //i - номер строки, j - номер столбца
//            }
//            System.out.println();
//        }
