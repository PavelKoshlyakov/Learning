package learn.java.t1_core.Collections;
...
//        System.out.println(list);
        ...
        //Инициализация нового списка с использованием значений другого списка
//        ArrayList<Integer> list = new ArrayList<>(List.of(10, 20, -5, -44, 66, 7));
...
//================================================= SET ================================================================
        ...
        // Хранит данные
//        HashSet<Integer> integerHashSet = new HashSet<>(List.of(10, 50, 33, 40, -8, 66, 10));
...
//        System.out.println(hashMap);
        ...
        //Пример 3. Найти ключ по значению
//        HashMap<String, Integer> map = new HashMap<>();
//        map.put("Иванов", 5);
//        map.put("Петров", 4);
//        map.put("Сидоров", 4);
